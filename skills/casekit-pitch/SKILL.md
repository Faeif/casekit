...
3. Build a claim sequence: tension → evidence → insight → choice → mechanism → proof → economics → execution → vision → ask.
4. Map each claim to rubric criterion, evidence/assumption IDs, and likely objection.
5. Design slides only after the claim sequence works in plain text.
